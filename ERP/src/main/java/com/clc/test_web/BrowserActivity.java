...
import com.clc.test_web.x5webview.X5WebView;
...
public class BrowserActivity extends Activity {
    ...
    private static final String mHomeUrl = GlobalConstants.HOME_URL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filter.addAction("closs");
        clossReceiver = new ClossReceiver(this);
        //注册广播接收
        registerReceiver(clossReceiver, filter);
    ...
    private void init() {
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                try {
                    jsonObject.put("RegistrationID",mRegistrationID);
                ...
                mWebView.loadUrl("javascript:getReg('" + s + "')");
//                mWebView.loadUrl("javascript:myFunction('1+"2"+3')");
                Log.i(TAG, "onPageFinished:getReg('123')");
...
//            mWebView.loadUrl(GlobalConstants.assets_path);
        } else {
    ...
    protected void onDestroy() {
        unregisterReceiver(clossReceiver);
    ...
    class ClossReceiver extends BroadcastReceiver {
        private Activity mActivity;

        ClossReceiver(Activity activity) {
            mActivity = activity;
        }
